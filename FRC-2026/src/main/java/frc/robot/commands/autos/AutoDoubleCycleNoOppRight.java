...
public class AutoDoubleCycleNoOppRight implements AutoCommand {
  ...
  public AutoDoubleCycleNoOppRight(
      final SwerveSubsystem swerve, final IntakeSubsystem intake, final boolean isLeft) {
    m_first = new QuikPlanSwervePartialTrajectoryReader("first_cycle_no_opp.csv", isLeft);

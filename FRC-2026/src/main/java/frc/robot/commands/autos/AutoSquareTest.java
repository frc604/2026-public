...
public class AutoSquareTest implements AutoCommand {
  private final QuikPlanSwervePartialTrajectoryReader m_traj =
      new QuikPlanSwervePartialTrajectoryReader("square_test.csv");

  private final Command m_command;

  public AutoSquareTest(final SwerveSubsystem swerve, final IntakeSubsystem intake) {

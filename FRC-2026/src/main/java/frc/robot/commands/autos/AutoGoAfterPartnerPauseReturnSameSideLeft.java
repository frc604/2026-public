...
public class AutoGoAfterPartnerPauseReturnSameSideLeft implements AutoCommand {
  ...
  public AutoGoAfterPartnerPauseReturnSameSideLeft(
      final SwerveSubsystem swerve, final IntakeSubsystem intake) {
    m_swerve = swerve;
    m_intake = intake;
    m_first = new QuikPlanSwervePartialTrajectoryReader("go_after_partner_with_pause.csv", true);

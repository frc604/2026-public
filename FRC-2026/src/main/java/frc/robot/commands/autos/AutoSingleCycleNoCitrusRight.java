...
public class AutoSingleCycleNoCitrusRight implements AutoCommand {
  ...
  public AutoSingleCycleNoCitrusRight(
    ...
    m_second = new QuikPlanSwervePartialTrajectoryReader("second_cycle_no_citrus.csv", isLeft);
    m_command =

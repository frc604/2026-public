...
public class AutoCenterPauseSlowLeftXXXX implements AutoCommand {
  ...
  public AutoCenterPauseSlowLeftXXXX(final SwerveSubsystem swerve, final IntakeSubsystem intake) {
    m_first = new QuikPlanSwervePartialTrajectoryReader("center_pause_slow_XXXX.csv", true);
    m_second =
        new QuikPlanSwervePartialTrajectoryReader("center_pause_slow_sweep_hub_XXXX.csv", true);

...
public class AutoCenterPauseSlowRightXXXX implements AutoCommand {
  ...
  public AutoCenterPauseSlowRightXXXX(final SwerveSubsystem swerve, final IntakeSubsystem intake) {
    m_first = new QuikPlanSwervePartialTrajectoryReader("center_pause_slow_XXXX.csv");
    m_second = new QuikPlanSwervePartialTrajectoryReader("center_pause_slow_sweep_hub_XXXX.csv");

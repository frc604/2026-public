...
public class AutoDoubleCycleRightInsideOut implements AutoCommand {
  ...
  public AutoDoubleCycleRightInsideOut(
    ...
    m_second = new QuikPlanSwervePartialTrajectoryReader("second_cycle_inside_out.csv", isLeft);
    m_command =

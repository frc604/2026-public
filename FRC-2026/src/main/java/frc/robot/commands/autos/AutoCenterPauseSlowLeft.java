...
public class AutoCenterPauseSlowLeft implements AutoCommand {
  ...
  public AutoCenterPauseSlowLeft(final SwerveSubsystem swerve, final IntakeSubsystem intake) {
    m_first = new QuikPlanSwervePartialTrajectoryReader("center_pause_slow.csv", true);
    m_second = new QuikPlanSwervePartialTrajectoryReader("center_pause_slow_sweep_hub.csv", true);

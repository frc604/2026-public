...
public class AutoFastRaceRight implements AutoCommand {
  ...
  public AutoFastRaceRight(final SwerveSubsystem swerve, final IntakeSubsystem intake) {
    m_swerve = swerve;
    m_intake = intake;
    m_first = new QuikPlanSwervePartialTrajectoryReader("fast_race.csv", false);
    m_second = new QuikPlanSwervePartialTrajectoryReader("fast_race_return.csv", false);

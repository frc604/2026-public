...
public class AutoCenterPauseHub implements AutoCommand {
  ...
  public AutoCenterPauseHub(
    ...
    m_second = new QuikPlanSwervePartialTrajectoryReader("center_pause_sweep_hub.csv", isLeft);
    m_command =

...
public class AutoCenterPauseOpp implements AutoCommand {
  ...
  public AutoCenterPauseOpp(
    ...
    m_second = new QuikPlanSwervePartialTrajectoryReader("center_pause_sweep_opp.csv", isLeft);
    m_command =

...
public class QuixTalonFX implements QuixIO, QuixMotorControllerWithEncoder, AutoCloseable {
  ...
  private static final ExecutorService s_configExecutor = Executors.newSingleThreadExecutor();
  ...
  private final PositionTorqueCurrentFOC m_positionTorqueCurrentControl =
  ...
  private final QuixStatusSignal<Voltage> m_supplyVoltageSignal;
  ...
  public static class TalonFXInputs {
    ...
    protected double supplyVoltage = 0.0;
  ...
  public static class QuixTalonFXConfiguration {
    ...
    public QuixTalonFXConfiguration setEnableFOC(final boolean enableFOC) {
      ENABLE_FOC = enableFOC;
      return this;
    }
    ...
    public TalonFXConfiguration toTalonFXConfiguration(
      ...
      if (!Robot.isSimulation()) {
        // TODO (02/23/2026): Figure out why stator current limtis are broken in sim.
  ...
  public QuixTalonFX(
    ...
    m_controller.setControl(new StrictFollower(leader.getCANDeviceID().deviceNumber));
  }
  ...
  public QuixTalonFX(
    ...
    m_canID = canID;
    m_controller = new TalonFX(canID.deviceNumber, canID.CANBus.rawCANBus());
    ...
    m_supplyVoltageSignal = new QuixStatusSignal<>(m_controller.getSupplyVoltage());
    ...
    QuixPowerMonitor.registerDevice(this);
  }
  ...
  public boolean setConfiguration() {
    ...
    allSuccess &=
        PhoenixUtil.retryUntilSuccess(
            () -> m_supplyVoltageSignal.setUpdateFrequency(kUpdateFrequency, kCANTimeoutS),
            () -> m_supplyVoltageSignal.getAppliedUpdateFrequency() == kUpdateFrequency,
            m_name + ": m_supplyVoltageSignal.setUpdateFrequency()");
    allSuccess &=
        PhoenixUtil.retryUntilSuccess(
  ...
  public TalonFXConfiguration getConfiguration() {
    return m_config.toTalonFXConfiguration(
  ...
  public void updateInputs() {
    ...
    m_inputs.supplyVoltage = m_supplyVoltageSignal.getUnitConvertedValue();
  ...
  public void setRotorBootOffset(final double offset) {
    m_config.rotorBootOffset = offset;
    m_controller
        .getConfigurator()
        .apply(
  ...
  public void setStatorCurrentLimit(final double amps) {
    if (amps == m_config.STATOR_CURRENT_LIMIT) {
      return;
    }

    m_config.STATOR_CURRENT_LIMIT = amps;

    // Run the blocking CAN apply in a background thread to avoid blocking the main loop.
    s_configExecutor.execute(
        () ->
            m_controller
                .getConfigurator()
                .apply(
  ...
  public void setSupplyCurrentLimit(final double amps) {
    if (amps == m_config.SUPPLY_CURRENT_LIMIT) {
      return;
    }
  ...
  public void setPercentOutput(final double percent) {
    m_dutyCycleControl.EnableFOC = m_config.ENABLE_FOC;
  ...
  public void setVoltageOutput(final double voltage) {
    m_voltageControl.EnableFOC = m_config.ENABLE_FOC;
  ...
  public void setPositionSetpoint(
    ...
    m_positionControl.EnableFOC = m_config.ENABLE_FOC;
  ...
  public void setPositionTorqueCurrentSetpoint(
      final int slot, final double setpoint, final double velocity, final double currentAmps) {
    m_positionTorqueCurrentControl.Slot = slot;
    m_positionTorqueCurrentControl.Position = toNativeSensorPosition(setpoint);
    m_positionTorqueCurrentControl.Velocity = toNativeSensorVelocity(velocity);
    m_positionTorqueCurrentControl.FeedForward = currentAmps;
    m_controller.setControl(m_positionTorqueCurrentControl);
  }
  ...
  public void setMotionMagicPositionSetpoint(
      final int slot, final double setpoint, final double feedforwardVolts) {
    m_motionMagicControl.EnableFOC = m_config.ENABLE_FOC;
  ...
  public void setDynamicMotionMagicPositionSetpoint(
    ...
    m_dynamicMotionMagicControl.EnableFOC = m_config.ENABLE_FOC;
  ...
  public void setVelocitySetpoint(
      ...
      final double feedforwardVolts) {
    m_velocityControl.EnableFOC = m_config.ENABLE_FOC;
  ...
  public void setSimSupplyVoltage(double volts) {
    m_simState.setSupplyVoltage(volts);
  }
}

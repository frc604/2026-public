...
public class QuikPlanSwervePartialTrajectoryReader {
  ...
  public QuikplanTrajectoryState getState(final double time) {
    ...
    // 2026 field is rotationally symmetric
    final double fieldLength = Units.inchesToMeters(12 * 54 + 2.5975);
    final double fieldWidth = Units.inchesToMeters(12 * 26 + 5.6875);
